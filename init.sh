...
configure_gnome_settings() {
    ...
    dconf write /org/gnome/shell/favorite-apps "['firefox.desktop', 'virtualbox.desktop', 'org.gnome.Nautilus.desktop', 'com.gexperts.Tilix.desktop']"
    gnome-extensions enable user-theme@gnome-shell-extensions.gcampax.github.com
    gsettings set org.gnome.shell.extensions.user-theme name Flat-Remix-Orange-Darkest-fullPanel
    gsettings set org.gnome.desktop.interface gtk-theme Flat-Remix-GTK-Orange-Darkest-Solid
